...
export const SECTIONS: SectionEntry[] = [
  ...
  { id: "pattern-wizard",     label: "Wizard",           category: "patterns", Component: WizardDoc },
  { id: "pattern-inline-edit", label: "Inline Edit",     category: "patterns", Component: InlineEditDoc },
  { id: "pattern-card-grid",  label: "Card Grid",        category: "patterns", Component: CardGridDoc },
  { id: "pattern-bulk-action", label: "Bulk Action Bar", category: "patterns", Component: BulkActionBarDoc },
